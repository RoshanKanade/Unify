package com.matchingnonmatchingelementsbothagents.util;
...
public class UtilityFile
{
	...
	public static void screenShot(WebDriver driver) 
	{
		...
		try {
			FileUtils.copyFile(src, new File("C:\\Users\\funak\\AutomationTester\\ExceptionalCasesInstitution\\AppScreen\\"+d+".png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
